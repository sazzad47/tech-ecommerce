  ...
  return (
    ...
    >
      <div className="w-full flex flex-col sm:flex-row gap-5">
        <div className="w-full sm:w-1/3 bg-black-gradient-2 max-h-[100vh] overflow-y-auto">
              ...
              {isFetchingProfile ? (
                ...
                <>
                  ...
                  <div className="w-full flex flex-col items-center">
                    ...
                    <h3 className="text-sm font-bold mt-2 text-secondaryTheme bg-green-700 px-3 py-2 rounded-full">
                      {data.is_volunteer? "Volunteer": "General Member"}
                    </h3>
                  </div>
                </>
              )}
