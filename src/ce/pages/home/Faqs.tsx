...
const Faqs: React.FC = () => {
  ...
  return (
    <section
      ...
      className="w-full flex flex-col justify-center items-center bg-cover bg-center py-[2rem]"
    >
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <p
          className={`${styles.paragraph} text-center text-pink-700 text-2xl`}
        >
          Find answers to common queries below
        </p>
        <div className="w-full max-w-xl p-5 flex flex-col gap-5 rounded-[20px]">
          {faqsList.map((item, i) => (
