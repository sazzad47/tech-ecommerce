...
export const itApi = createApi({
  ...
  baseQuery: fetchBaseQuery({
    baseUrl: `${process.env.REACT_APP_BASE_BACKEND_URL}/api/it/`,
  }),
  endpoints: (builder) => ({
...
export const { useCreateOrderMutation, useGetOrdersQuery, useGetOrderDetailsQuery, useUpdateOrderMutation, useCreatePaymentSessionMutation, useGetTransactionsQuery } = itApi;
