  ...
  return (
    <div className="w-full px-[1rem] md:px-[5rem] flex flex-col gap-5 items-center">
      <div className="w-full text-center text-gray-900 my-[3rem]">
        ...
        To place an order, please fill out the form with the required details. Ensure accurate contact and shipping information for a smooth
        ...
        <MobileStepper
          ...
          nextButton={
            <Button
              ...
              className="focus:outline-none normal-case px-4 text-white bg-fuchsia-900"
            >
