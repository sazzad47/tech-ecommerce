    ...
    <div className="flex flex-col relative pb-[5rem]">
      <div className="w-full px-[1rem] md:px-[5rem] flex flex-col gap-5 items-center">
        <div className="w-full text-center text-gray-900 my-[3rem]">
          ...
          <TableContainer className="bg-gray-100 mt-[5rem]" component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              ...
              <TableBody>
                ...
                >
                  ...
                  <TableCell className="text-gray-900">example@example.com</TableCell>
                  <TableCell className="text-gray-900">Dhaka, Bangladesh</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </TableContainer>
